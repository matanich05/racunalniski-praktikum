...
\begin{enumerate}
   \item Z zanko se sprehodimo po vektorju vseh predmetov. Predmet na $n$-tem koraku označimo s $P_n$.
   \item Naslednja vgnezdena zanka nas popelje po vseh predavalnicah. Predavalnico na $m$-tem koraku označimo s $R_m$.
   \item Za vse proste termine $T$ izračunamo ceno vstavljanja srečanja, ki ga sestavlja $P_n$, profesor, ki ta predmet predava,
   ...
   vstavljanja, da bomo $P_n$ na koncu vstavili v termin z najboljšo
   ceno vstavljanja.
   \item Ko preverimo vse proste termine vseh predavalnic, vstavimo $P_n$
...
\begin{enumerate}
   ...
   \item Na vsakem koraku ocenimo izboljšano rešitev $r$. Če je vrednost kriterijske funkcije
...
\subsubsection{Zaključek} % podrazdelek
